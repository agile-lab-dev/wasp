...
trait JsonSupport extends SprayJsonSupport with DefaultJsonProtocol {
  ...
  implicit val kafkaEntryConfigModelFormat: RootJsonFormat[KafkaEntryConfigModel] = jsonFormat2(KafkaEntryConfigModel.apply)
  ...
  implicit val sparkEntryConfigModelConfigFormat: RootJsonFormat[SparkEntryConfigModel] = jsonFormat2(SparkEntryConfigModel.apply)
