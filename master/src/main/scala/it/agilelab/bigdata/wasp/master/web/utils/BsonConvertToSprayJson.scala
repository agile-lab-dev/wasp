...
trait JsonSupport extends SprayJsonSupport with DefaultJsonProtocol {
  ...
  implicit val writerModelFormat: RootJsonFormat[WriterModel] = jsonFormat3((name: String, endpointId: BsonObjectId, writerType: WriterType) => WriterModel.apply(name, Some(endpointId), writerType))
