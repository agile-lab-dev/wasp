...
import it.agilelab.bigdata.wasp.master.security.common.{
...
class NoSecurity extends AuthenticationService with AuthenticationProvider with CredentialsVerifier {
  ...
  override def verifyCredentials: Directives.AsyncAuthenticatorPF[Identity] = { case _ =>
    Future.failed[Identity](new UnsupportedOperationException())
  }
}
