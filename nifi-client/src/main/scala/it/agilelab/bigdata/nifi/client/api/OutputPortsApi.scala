...
object OutputPortsApi {
  ...
  def apply(baseUrl: String = "http://localhost/nifi-api")(implicit serializer: SttpSerializer) = new OutputPortsApi(baseUrl)
}
...
class OutputPortsApi(baseUrl: String)(implicit serializer: SttpSerializer) {
   ...
   */
  def removeOutputPort(id: String, version: Option[String] = None, clientId: Option[String] = None, disconnectedNodeAcknowledged: Option[Boolean] = None): ApiRequestT[PortEntity] =
    basicRequest
      .method(Method.DELETE, uri"$baseUrl/output-ports/${id}?version=$version&clientId=$clientId&disconnectedNodeAcknowledged=$disconnectedNodeAcknowledged")
      .contentType("application/json")
      .response(asJson[PortEntity])
