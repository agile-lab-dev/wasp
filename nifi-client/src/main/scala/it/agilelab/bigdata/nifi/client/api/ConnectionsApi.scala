...
object ConnectionsApi {
  ...
  def apply(baseUrl: String = "http://localhost/nifi-api")(implicit serializer: SttpSerializer) = new ConnectionsApi(baseUrl)
}
...
class ConnectionsApi(baseUrl: String)(implicit serializer: SttpSerializer) {
   ...
   */
  def deleteConnection(id: String, version: Option[String] = None, clientId: Option[String] = None, disconnectedNodeAcknowledged: Option[Boolean] = None): ApiRequestT[ConnectionEntity] =
    basicRequest
      .method(Method.DELETE, uri"$baseUrl/connections/${id}?version=$version&clientId=$clientId&disconnectedNodeAcknowledged=$disconnectedNodeAcknowledged")
