...
import it.agilelab.bigdata.nifi.client.model.{
  AccessPolicyDTOEnums,
  AccessPolicySummaryDTOEnums,
  ActivateControllerServicesEntityEnums,
  AffectedComponentDTOEnums,
  AffectedComponentEntityEnums,
  ComponentValidationResultDTOEnums,
  ConnectableComponentEnums,
  ConnectableDTOEnums,
  ConnectionDTOEnums,
  ConnectionEntityEnums,
  ControllerServiceDTOEnums,
  ControllerServiceReferencingComponentDTOEnums,
  ControllerServiceRunStatusEntityEnums,
  ControllerServiceStatusDTOEnums,
  FlowBreadcrumbEntityEnums,
  LineageRequestDTOEnums,
  PortDTOEnums,
  PortRunStatusEntityEnums,
  PortStatusDTOEnums,
  PortStatusSnapshotDTOEnums,
  ProcessGroupEntityEnums,
  ProcessGroupStatusSnapshotDTOEnums,
  ProcessorDTOEnums,
  ProcessorRunStatusEntityEnums,
  ProcessorStatusDTOEnums,
  ProcessorStatusSnapshotDTOEnums,
  ProvenanceNodeDTOEnums,
  RemotePortRunStatusEntityEnums,
  RemoteProcessGroupStatusDTOEnums,
  ReportingTaskDTOEnums,
  ReportingTaskRunStatusEntityEnums,
  ReportingTaskStatusDTOEnums,
  ScheduleComponentsEntityEnums,
  UpdateControllerServiceReferenceRequestEntityEnums,
  VersionControlInformationDTOEnums,
  VersionedConnectionEnums,
  VersionedControllerServiceEnums,
  VersionedFlowDTOEnums,
  VersionedFlowEnums,
  VersionedFunnelEnums,
  VersionedLabelEnums,
  VersionedPortEnums,
  VersionedProcessGroupEnums,
  VersionedProcessorEnums,
  VersionedRemoteGroupPortEnums,
  VersionedRemoteProcessGroupEnums
}
import org.json4s._
