...
import it.agilelab.bigdata.nifi.client.model.{ConnectionEntity, ConnectionsEntity, ControllerServiceEntity, CopySnippetRequestEntity, CreateTemplateRequestEntity, FlowComparisonEntity, FlowEntity, FunnelEntity, FunnelsEntity, InputPortsEntity, InstantiateTemplateRequestEntity, LabelEntity, LabelsEntity, OutputPortsEntity, PortEntity, ProcessGroupEntity, ProcessGroupsEntity, ProcessorEntity, ProcessorsEntity, RemoteProcessGroupEntity, RemoteProcessGroupsEntity, TemplateEntity, VariableRegistryEntity, VariableRegistryUpdateRequestEntity}
import sttp.client._
import sttp.model.Method

object ProcessGroupsApi {

  def apply(baseUrl: String = "http://localhost/nifi-api")(implicit serializer: SttpSerializer) = new ProcessGroupsApi(baseUrl)
}
...
class ProcessGroupsApi(baseUrl: String)(implicit serializer: SttpSerializer) {
   ...
   */
  def deleteVariableRegistryUpdateRequest(groupId: String, updateId: String, disconnectedNodeAcknowledged: Option[Boolean] = None): ApiRequestT[VariableRegistryUpdateRequestEntity] =
    basicRequest
      .method(Method.DELETE, uri"$baseUrl/process-groups/${groupId}/variable-registry/update-requests/${updateId}?disconnectedNodeAcknowledged=$disconnectedNodeAcknowledged")
      .contentType("application/json")
  ...
  def getProcessors(id: String, includeDescendantGroups: Option[Boolean] = None): ApiRequestT[ProcessorsEntity] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/process-groups/${id}/processors?includeDescendantGroups=$includeDescendantGroups")
      .contentType("application/json")
   ...
   */
  def getVariableRegistry(id: String, includeAncestorGroups: Option[Boolean] = None): ApiRequestT[VariableRegistryEntity] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/process-groups/${id}/variable-registry?includeAncestorGroups=$includeAncestorGroups")
      .contentType("application/json")
   ...
   * @param updateId The ID of the Variable Registry Update Request
   */
  def getVariableRegistryUpdateRequest(groupId: String, updateId: String): ApiRequestT[VariableRegistryUpdateRequestEntity] =
    basicRequest
   ...
   * @param disconnectedNodeAcknowledged Acknowledges that this node is disconnected to allow for mutable requests to proceed.
   */
  def removeProcessGroup(id: String, version: Option[String] = None, clientId: Option[String] = None, disconnectedNodeAcknowledged: Option[Boolean] = None): ApiRequestT[ProcessGroupEntity] =
    basicRequest
      .method(Method.DELETE, uri"$baseUrl/process-groups/${id}?version=$version&clientId=$clientId&disconnectedNodeAcknowledged=$disconnectedNodeAcknowledged")
      .contentType("application/json")
      .response(asJson[ProcessGroupEntity])
   ...
   */
  def submitUpdateVariableRegistryRequest(id: String, body: VariableRegistryEntity): ApiRequestT[VariableRegistryUpdateRequestEntity] =
    basicRequest
