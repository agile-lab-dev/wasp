...
class ProcessGroupsApi(baseUrl: String)(implicit serializer: SttpSerializer) {
  ...
  /** Expected answers: code 200 : FlowEntity (successful operation) code 400 : (NiFi was unable to complete the request
  ...
  /** Expected answers: code 200 : ConnectionEntity (successful operation) code 400 : (NiFi was unable to complete the
  ...
  /** Expected answers: code 200 : ControllerServiceEntity (successful operation) code 400 : (NiFi was unable to
  ...
  /** Expected answers: code 200 : FunnelEntity (successful operation) code 400 : (NiFi was unable to complete the
    * request because it was invalid. The request should not be retried without modification.) code 401 : (Client could
    * not be authenticated.) code 403 : (Client is not authorized to make this request.) code 404 : (The specified
    * resource could not be found.) code 409 : (The request was valid but NiFi was not in the appropriate state to
    * process it. Retrying the same request later may be successful.)
  ...
  /** Expected answers: code 200 : LabelEntity (successful operation) code 400 : (NiFi was unable to complete the
    * request because it was invalid. The request should not be retried without modification.) code 401 : (Client could
    * not be authenticated.) code 403 : (Client is not authorized to make this request.) code 404 : (The specified
    * resource could not be found.) code 409 : (The request was valid but NiFi was not in the appropriate state to
    * process it. Retrying the same request later may be successful.)
  ...
  /** Expected answers: code 200 : ProcessGroupEntity (successful operation) code 400 : (NiFi was unable to complete the
    * request because it was invalid. The request should not be retried without modification.) code 401 : (Client could
    * not be authenticated.) code 403 : (Client is not authorized to make this request.) code 404 : (The specified
    * resource could not be found.) code 409 : (The request was valid but NiFi was not in the appropriate state to
    * process it. Retrying the same request later may be successful.)
  ...
  /** Expected answers: code 200 : ProcessorEntity (successful operation) code 400 : (NiFi was unable to complete the
    * request because it was invalid. The request should not be retried without modification.) code 401 : (Client could
    * not be authenticated.) code 403 : (Client is not authorized to make this request.) code 404 : (The specified
    * resource could not be found.) code 409 : (The request was valid but NiFi was not in the appropriate state to
    * process it. Retrying the same request later may be successful.)
  ...
  /** Expected answers: code 200 : RemoteProcessGroupEntity (successful operation) code 400 : (NiFi was unable to
    * complete the request because it was invalid. The request should not be retried without modification.) code 401 :
  ...
  /** Expected answers: code 200 : TemplateEntity (successful operation) code 400 : (NiFi was unable to complete the
    * request because it was invalid. The request should not be retried without modification.) code 401 : (Client could
    * not be authenticated.) code 403 : (Client is not authorized to make this request.) code 404 : (The specified
    * resource could not be found.) code 409 : (The request was valid but NiFi was not in the appropriate state to
    * process it. Retrying the same request later may be successful.)
  ...
  /** Note: This endpoint is subject to change as NiFi and it's REST API evolve.
    *
    * Expected answers: code 200 : VariableRegistryUpdateRequestEntity (successful operation) code 400 : (NiFi was
  ...
  /** Expected answers: code 200 : ConnectionsEntity (successful operation) code 400 : (NiFi was unable to complete the
    * request because it was invalid. The request should not be retried without modification.) code 401 : (Client could
    * not be authenticated.) code 403 : (Client is not authorized to make this request.) code 404 : (The specified
    * resource could not be found.) code 409 : (The request was valid but NiFi was not in the appropriate state to
    * process it. Retrying the same request later may be successful.)
  ...
  /** Expected answers: code 200 : FunnelsEntity (successful operation) code 400 : (NiFi was unable to complete the
    * request because it was invalid. The request should not be retried without modification.) code 401 : (Client could
    * not be authenticated.) code 403 : (Client is not authorized to make this request.) code 404 : (The specified
    * resource could not be found.) code 409 : (The request was valid but NiFi was not in the appropriate state to
    * process it. Retrying the same request later may be successful.)
  ...
  /** Expected answers: code 200 : InputPortsEntity (successful operation) code 400 : (NiFi was unable to complete the
    * request because it was invalid. The request should not be retried without modification.) code 401 : (Client could
    * not be authenticated.) code 403 : (Client is not authorized to make this request.) code 404 : (The specified
    * resource could not be found.) code 409 : (The request was valid but NiFi was not in the appropriate state to
    * process it. Retrying the same request later may be successful.)
  ...
  /** Expected answers: code 200 : LabelsEntity (successful operation) code 400 : (NiFi was unable to complete the
    * request because it was invalid. The request should not be retried without modification.) code 401 : (Client could
    * not be authenticated.) code 403 : (Client is not authorized to make this request.) code 404 : (The specified
    * resource could not be found.) code 409 : (The request was valid but NiFi was not in the appropriate state to
    * process it. Retrying the same request later may be successful.)
  ...
  /** Expected answers: code 200 : FlowComparisonEntity (successful operation) code 400 : (NiFi was unable to complete
  ...
  /** Expected answers: code 200 : OutputPortsEntity (successful operation) code 400 : (NiFi was unable to complete the
    * request because it was invalid. The request should not be retried without modification.) code 401 : (Client could
    * not be authenticated.) code 403 : (Client is not authorized to make this request.) code 404 : (The specified
    * resource could not be found.) code 409 : (The request was valid but NiFi was not in the appropriate state to
    * process it. Retrying the same request later may be successful.)
  ...
  /** Expected answers: code 200 : ProcessGroupsEntity (successful operation) code 400 : (NiFi was unable to complete
    * the request because it was invalid. The request should not be retried without modification.) code 401 : (Client
    * could not be authenticated.) code 403 : (Client is not authorized to make this request.) code 404 : (The specified
    * resource could not be found.) code 409 : (The request was valid but NiFi was not in the appropriate state to
    * process it. Retrying the same request later may be successful.)
  ...
  /** Expected answers: code 200 : ProcessorsEntity (successful operation) code 400 : (NiFi was unable to complete the
    * request because it was invalid. The request should not be retried without modification.) code 401 : (Client could
    * not be authenticated.) code 403 : (Client is not authorized to make this request.) code 404 : (The specified
    * resource could not be found.) code 409 : (The request was valid but NiFi was not in the appropriate state to
    * process it. Retrying the same request later may be successful.)
  ...
  /** Expected answers: code 200 : RemoteProcessGroupsEntity (successful operation) code 400 : (NiFi was unable to
    * complete the request because it was invalid. The request should not be retried without modification.) code 401 :
    * (Client could not be authenticated.) code 403 : (Client is not authorized to make this request.) code 404 : (The
    * specified resource could not be found.) code 409 : (The request was valid but NiFi was not in the appropriate
    * state to process it. Retrying the same request later may be successful.)
  ...
  /** Note: This endpoint is subject to change as NiFi and it's REST API evolve.
    *
    * Expected answers: code 200 : VariableRegistryEntity (successful operation) code 400 : (NiFi was unable to complete
    * the request because it was invalid. The request should not be retried without modification.) code 401 : (Client
    * could not be authenticated.) code 403 : (Client is not authorized to make this request.) code 404 : (The specified
    * resource could not be found.) code 409 : (The request was valid but NiFi was not in the appropriate state to
    * process it. Retrying the same request later may be successful.)
  ...
  /** Expected answers: code 200 : ProcessGroupEntity (successful operation) code 400 : (NiFi was unable to complete the
    ...
    * @param clientId
    *   If the client id is not specified, new one will be generated. This value (whether specified or generated) is
