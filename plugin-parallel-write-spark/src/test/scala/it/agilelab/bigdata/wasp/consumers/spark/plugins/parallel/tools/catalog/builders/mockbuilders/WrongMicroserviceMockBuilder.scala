...
object WrongMicroserviceMockBuilder extends EntityCatalogBuilder {
  override def getEntityCatalogService(): EntityCatalogService = {
    getEntityCatalogService("plugin.microservice-catalog-wrongmicroserviceclass.catalog-class")
  }
}
