object SparkDependecies {
  // Exclude the spark 2.2 dependencies
  val excludedJarsSpark2 = Set(
    "JavaEWAH-0.3.2.jar",
    ...
    "spark-2.2.1-yarn-shuffle.jar",
    "spark-catalyst_2.11-2.2.1.jar",
    "spark-core_2.11-2.2.1.jar",
    "spark-graphx_2.11-2.2.1.jar",
    "spark-hive-thriftserver_2.11-2.2.1.jar",
    "spark-hive_2.11-2.2.1.jar",
    "spark-launcher_2.11-2.2.1.jar",
    "spark-mesos_2.11-2.2.1.jar",
    "spark-mllib-local_2.11-2.2.1.jar",
    "spark-mllib_2.11-2.2.1.jar",
    "spark-network-common_2.11-2.2.1.jar",
    "spark-network-shuffle_2.11-2.2.1.jar",
    "spark-repl_2.11-2.2.1.jar",
    "spark-sketch_2.11-2.2.1.jar",
    "spark-sql_2.11-2.2.1.jar",
    "spark-streaming_2.11-2.2.1.jar",
    "spark-tags_2.11-2.2.1.jar",
    "spark-unsafe_2.11-2.2.1.jar",
    "spark-yarn_2.11-2.2.1.jar",
