...
class CDP719Dependencies(versions: CDP719Versions) extends Dependencies {
  ...
  implicit class Exclude(module: ModuleID) {
    // The library "jwtprovider-knox":"0.10.0.0.1.0-b8" and "jwtprovider-api":"0.10.0.0.1.0-b8" not exist in any repository
    def jwtproviderExclude: ModuleID =
      module
        .exclude("com.cloudera", "jwtprovider-knox")
        .exclude("com.cloudera", "jwtprovider-api")
  }
  ...
  lazy val parcelDependencies = Seq(
    ...
    "com.google.cloud.bigdataoss"      % "gcs-connector"                               % "2.1.2.7.1.9.0-387" classifier ("shaded"),
    ...
    "org.apache.avro"                 % "avro"                                           % "1.11.1.7.1.9.0-387",
    ...
    "org.apache.curator"              % "curator-client"                                 % "5.4.0.7.1.9.0-387",
    "org.apache.curator"              % "curator-framework"                              % "5.4.0.7.1.9.0-387",
    "org.apache.curator"              % "curator-recipes"                                % "5.4.0.7.1.9.0-387",
    "org.apache.derby"                % "derby"                                          % "10.14.2.0",
    "org.apache.geronimo.specs"       % "geronimo-jcache_1.0_spec"                       % "1.0-alpha-1",
    "org.apache.hadoop"               % "hadoop-aliyun"                                  % "3.1.1.7.1.9.0-387",
    ...
    "org.apache.hadoop"               % "hadoop-cloud-storage"                           % "3.1.1.7.1.9.0-387" jwtproviderExclude,
    ...
    "org.apache.hive"                 % "hive-beeline"                                   % "3.1.3000.7.1.9.0-387",
    ...
    "org.apache.hive"                 % "hive-hplsql"                                    % "3.1.3000.7.1.9.0-387",
    ...
    "org.apache.knox"                 % "gateway-shell"                                  % "1.3.0.7.1.9.0-387" jwtproviderExclude,
    ...
    "org.apache.orc"                  % "orc-core"                                       % "1.5.1.7.1.9.0-387",
    "org.apache.orc"                  % "orc-mapreduce"                                  % "1.5.1.7.1.9.0-387",
    "org.apache.orc"                  % "orc-shims"                                      % "1.5.1.7.1.9.0-387",
    "org.apache.parquet"              % "parquet-avro"                                   % "1.10.99.7.1.9.0-387",
    ...
    "org.apache.ranger"               % "ranger-hdfs-plugin-shim"                        % "2.4.0.7.1.9.0-387" jwtproviderExclude,
    "org.apache.ranger"               % "ranger-hive-plugin-shim"                        % "2.4.0.7.1.9.0-387" jwtproviderExclude,
    "org.apache.ranger"               % "ranger-plugin-classloader"                      % "2.4.0.7.1.9.0-387",
    "org.apache.ranger"               % "ranger-raz-hook-abfs"                           % "2.4.0.7.1.9.0-387" jwtproviderExclude,
    "org.apache.ranger"               % "ranger-raz-intg"                                % "2.4.0.7.1.9.0-387" jwtproviderExclude,
    "org.apache.ranger"               % "ranger-yarn-plugin-shim"                        % "2.4.0.7.1.9.0-387" jwtproviderExclude,
    "org.apache.spark"                %% "spark-avro"                                    % "2.4.8.7.1.9.0-387",
    "org.apache.spark"                %% "spark-catalyst"                                % "2.4.8.7.1.9.0-387",
    "org.apache.spark"                %% "spark-core"                                    % "2.4.8.7.1.9.0-387",
    "org.apache.spark"                %% "spark-graphx"                                  % "2.4.8.7.1.9.0-387",
    "org.apache.spark"                %% "spark-hadoop-cloud"                            % "2.4.8.7.1.9.0-387",
    "org.apache.spark"                %% "spark-hive"                                    % "2.4.8.7.1.9.0-387",
    "org.apache.spark"                %% "spark-kubernetes"                              % "2.4.8.7.1.9.0-387",
    "org.apache.spark"                %% "spark-kvstore"                                 % "2.4.8.7.1.9.0-387",
    "org.apache.spark"                %% "spark-launcher"                                % "2.4.8.7.1.9.0-387",
    "org.apache.spark"                %% "spark-mllib"                                   % "2.4.8.7.1.9.0-387",
    "org.apache.spark"                %% "spark-mllib-local"                             % "2.4.8.7.1.9.0-387",
    "org.apache.spark"                %% "spark-network-common"                          % "2.4.8.7.1.9.0-387",
    "org.apache.spark"                %% "spark-network-shuffle"                         % "2.4.8.7.1.9.0-387",
    "org.apache.spark"                %% "spark-repl"                                    % "2.4.8.7.1.9.0-387",
    "org.apache.spark"                %% "spark-sketch"                                  % "2.4.8.7.1.9.0-387",
    "org.apache.spark"                %% "spark-tags"                                    % "2.4.8.7.1.9.0-387",
    "org.apache.spark"                %% "spark-unsafe"                                  % "2.4.8.7.1.9.0-387",
    "org.apache.spark"                %% "spark-yarn"                                    % "2.4.8.7.1.9.0-387",
    "org.apache.spark"                %% "spark-sql"                                     % "2.4.8.7.1.9.0-387",
    ...
    "org.apache.zookeeper"            % "zookeeper"                                      % "3.8.1.7.1.9.0-387",
