...
/** This is the hbase configuration. User can either set them in SparkConf, which will take effect globally, or
  * configure it per table, which will overwrite the value set in SparkConf. If not set, the default value will take
  * effect.
  */
@InterfaceAudience.Public
object HBaseSparkConf {

  /** Set to false to disable server-side caching of blocks for this scan, false by default, since full table scans
    * generate too much BC churn.
    */
