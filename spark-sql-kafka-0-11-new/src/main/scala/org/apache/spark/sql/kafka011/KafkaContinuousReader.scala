...
import org.apache.spark.sql.kafka011.KafkaSourceProvider.{INSTRUCTION_FOR_FAIL_ON_DATA_LOSS_FALSE, INSTRUCTION_FOR_FAIL_ON_DATA_LOSS_TRUE}
...
class KafkaContinuousReader(
  ...
  override def readSchema: StructType = KafkaSparkSQLSchemas.INPUT_SCHEMA
