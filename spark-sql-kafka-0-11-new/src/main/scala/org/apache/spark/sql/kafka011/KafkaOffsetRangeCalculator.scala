 ...
 */
private[kafka011] class KafkaOffsetRangeCalculator(val minPartitions: Option[Int]) {
...
private[kafka011] object KafkaOffsetRangeCalculator {
...
private[kafka011] case class KafkaOffsetRange(
