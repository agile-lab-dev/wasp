...
lazy val versions = Versions.build(flavor)
lazy val resolver = Resolvers.build(flavor)
lazy val dependencies = Dependencies.build(flavor, versions)
lazy val settings = Settings.build(flavor, versions, resolver)
