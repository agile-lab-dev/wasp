...
class ImplBacklogSizeAnalyzerProducerGuardian(
    env: { val producerBL: ProducerBL; val topicBL: TopicBL },
    producerName: String
) extends BacklogSizeAnalyzerProducerGuardian[String](env, producerName) {
...
class ImplBacklogSizeAnalyzerProducerActor(
    kafka_router: ActorRef,
    kafkaOffsetChecker: ActorRef,
    topic: Option[TopicModel],
    topicToCheck: String,
