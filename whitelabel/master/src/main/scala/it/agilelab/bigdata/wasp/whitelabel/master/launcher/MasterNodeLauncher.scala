...
object MasterNodeLauncher extends MasterNodeLauncherTrait {
  ...
  def addExamplePipegraphs(): Unit = {
    ...
    ConfigBL.topicBL.upsert(TestTopicModel.multitopicWriteMixed)
    ConfigBL.topicBL.upsert(TestTopicModel.avro_forMixed)
    ConfigBL.topicBL.upsert(TestTopicModel.json_forMixed)
    ...
    ConfigBL.pipegraphBL.upsert(TestPipegraphs.JSON.Structured.kafkaMultitopicWriteMixed)
