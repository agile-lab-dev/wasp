...
#cat ${TEMPLATE_DIR}/spark2/spark2-shell | envsubst \$HOSTNAME > /opt/parcels/CDH-6.3.2-1.cdh6.3.2.p0.1605554/bin/spark2-shell
#cat ${TEMPLATE_DIR}/spark2/spark2-submit | envsubst \$HOSTNAME > /opt/parcels/CDH-6.3.2-1.cdh6.3.2.p0.1605554/bin/spark2-submit
