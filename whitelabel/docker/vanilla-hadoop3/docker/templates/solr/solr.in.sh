...
SOLR_OPTS="$SOLR_OPTS -Dsolr.directoryFactory=HdfsDirectoryFactory -Dsolr.lock.type=hdfs -Dsolr.hdfs.home=hdfs://$HOSTNAME:9000/solr"
ZK_HOST="$HOSTNAME:2181/solr"