...
import it.agilelab.bigdata.wasp.repository.core.dbModels.{CompilerConfigDBModel, ElasticConfigDBModel, HBaseConfigDBModel, JdbcConfigDBModel, KafkaConfigDBModel, NifiConfigDBModel, NifiConfigDBModelV1, SolrConfigDBModel, SparkBatchConfigDBModel, SparkStreamingConfigDBModel, TelemetryConfigDBModel}
...
class ConfigManagerBLImpl(waspDB: WaspMongoDB) extends ConfigManagerBL{
  ...
  def getByName[T <: Model](name : String)(implicit ct: ClassTag[T], typeTag: TypeTag[T]): Option[T] = {
    ...
    // TestMe: This should work with all possible mappers => Done
  ...
  def retrieveConf[T <: Model](default: T, nameConf: String)(implicit ct: ClassTag[T], typeTag: TypeTag[T]): Option[T] = {
    ...
    ct.runtimeClass match {
      case solr if solr == classOf[SolrConfigModel] =>
        waspDB.insertIfNotExists[SolrConfigDBModel](SolrConfigMapperV1.fromModelToDBModel(default.asInstanceOf[SolrConfigModel]))
        getByName[SolrConfigDBModel](nameConf).asInstanceOf[Option[T]]

      case hbase if hbase == classOf[HBaseConfigModel] =>
        waspDB.insertIfNotExists[HBaseConfigDBModel](HBaseConfigMapperV1.fromModelToDBModel(default.asInstanceOf[HBaseConfigModel]))
        getByName[HBaseConfigDBModel](nameConf).asInstanceOf[Option[T]]

      case kafka if kafka == classOf[KafkaConfigModel] =>
        waspDB.insertIfNotExists[KafkaConfigDBModel](KafkaConfigMapperV1.fromModelToDBModel(default.asInstanceOf[KafkaConfigModel]))
        getByName[KafkaConfigDBModel](nameConf).asInstanceOf[Option[T]]

      case sparkB if sparkB == classOf[SparkBatchConfigModel] =>
        waspDB.insertIfNotExists[SparkBatchConfigDBModel](SparkBatchConfigMapperV1.fromModelToDBModel(default.asInstanceOf[SparkBatchConfigModel]))
        getByName[SparkBatchConfigDBModel](nameConf).asInstanceOf[Option[T]]

      case sparkS if sparkS == classOf[SparkStreamingConfigModel] =>
        waspDB.insertIfNotExists[SparkStreamingConfigDBModel](SparkStreamingConfigMapperV1.fromModelToDBModel(default.asInstanceOf[SparkStreamingConfigModel]))
        getByName[SparkStreamingConfigDBModel](nameConf).asInstanceOf[Option[T]]

      case elastic if elastic == classOf[ElasticConfigModel] =>
        waspDB.insertIfNotExists[ElasticConfigDBModel](ElasticConfigMapperV1.fromModelToDBModel(default.asInstanceOf[ElasticConfigModel]))
        getByName[ElasticConfigDBModel](nameConf).asInstanceOf[Option[T]]

      case jdbc if jdbc == classOf[JdbcConfigModel] =>
        waspDB.insertIfNotExists[JdbcConfigDBModel](JdbcConfigMapperV1.fromModelToDBModel(default.asInstanceOf[JdbcConfigModel]))
        getByName[JdbcConfigDBModel](nameConf).asInstanceOf[Option[T]]

      case telemetry if telemetry == classOf[TelemetryConfigModel] =>
        waspDB.insertIfNotExists[TelemetryConfigDBModel](TelemetryConfigMapperV1.fromModelToDBModel(default.asInstanceOf[TelemetryConfigModel]))
        getByName[TelemetryConfigDBModel](nameConf).asInstanceOf[Option[T]]

      case compiler if compiler == classOf[CompilerConfigModel] =>
        waspDB.insertIfNotExists[CompilerConfigDBModel](CompilerConfigMapperV1.fromModelToDBModel(default.asInstanceOf[CompilerConfigModel]))
        getByName[CompilerConfigDBModel](nameConf).asInstanceOf[Option[T]]

      case nifi if nifi == classOf[NifiConfigModel] =>
        waspDB.insertIfNotExists[NifiConfigDBModel](NifiConfigMapperV1.fromModelToDBModel(default.asInstanceOf[NifiConfigModel]))
