...
import it.agile.bigdata.wasp.repository.postgres.{WaspPostgresDB, WaspPostgresDBImpl}
import it.agile.bigdata.wasp.repository.postgres.tables.MlModelOnlyInfoTableDefinition.{name, timestamp, version}
import it.agile.bigdata.wasp.repository.postgres.tables.{MlModelOnlyDataTableDefinition, MlModelOnlyInfoTableDefinition, TableDefinition}
