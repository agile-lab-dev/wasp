...
object MlModelOnlyDataTableDefinition
    extends TableDefinition[(BsonObjectId, String, BsonDocument, Array[Byte]), BsonObjectId] {
  ...
  override def primaryKeyFromObject: ((BsonObjectId, String, BsonDocument, Array[Byte])) => BsonObjectId = elem =>
    elem._1
}
