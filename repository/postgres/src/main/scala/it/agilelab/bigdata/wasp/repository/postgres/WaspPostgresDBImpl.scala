...
class WaspPostgresDBImpl(pgDBConf: PostgresDBConfigModel) extends WaspPostgresDB with JsonSupport {
  ...
  def getBy[T, K](condition: Array[(String, Any)], sortCondition: Option[String] = None, limit: Option[Int] = None)(
    ...
    selectAll(tableDefinition.tableName, tableDefinition.columns.toArray, Some(condition), sortCondition, limit)(
  ...
  def getByPrimaryKey[T, K](primaryKey: K)(implicit tableDefinition: TableDefinition[T, K]): Option[T] = {
    ...
    )(tableDefinition.from).headOption
  }
  ...
  def deleteByPrimaryKey[T, K](primaryKey: K)(implicit tableDefinition: TableDefinition[T, K]): Unit = {
    delete(tableDefinition.tableName, Some(tableDefinition.conditionPrimaryKey(primaryKey)))
  }
