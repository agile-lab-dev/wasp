...
object MlModelOnlyInfoTableDefinition extends TableDefinition[MlModelOnlyInfo, (String, String, Long)] {
  ...
  override def from: ResultSet => MlModelOnlyInfo = rs =>
    MlModelOnlyInfo(
      rs.getString(name),
  ...
  override def to: MlModelOnlyInfo => Array[(String, Any)] = model =>
    Array(
      (name, model.name),
  ...
  override def conditionPrimaryKey: ((String, String, Long)) => Array[(String, Any)] = k =>
    Array((name, k._1), (version, k._2), (timestamp, k._3))
