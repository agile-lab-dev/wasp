...
object Models {
  val models: Map[Object, String] = Map(
    ...
    classOf[PipegraphDBModelV2]             -> PipegraphMapperV2.version,
    ...
    classOf[KafkaAdditionalConfigDBModelV1] -> KafkaAdditionalConfigMapperV1.version,
...
object Mappers {
  val mappers: Map[String, Object] = Map(
    ...
    KafkaAdditionalConfigMapperV1.version -> KafkaAdditionalConfigMapperV1,
