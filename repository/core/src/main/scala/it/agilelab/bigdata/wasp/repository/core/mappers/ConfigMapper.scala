...
import it.agilelab.bigdata.wasp.repository.core.dbModels.{
  ...
  JdbcConfigDBModel,
  JdbcConfigDBModelV1,
  KafkaAdditionalConfigDBModel,
  KafkaAdditionalConfigDBModelV1,
  KafkaConfigDBModel,
...
object KafkaAdditionalConfigMapperSelector
    extends MapperSelector[AdditionalKafkaClustersConfig, KafkaAdditionalConfigDBModel]

object KafkaAdditionalConfigMapperV1
    extends SimpleMapper[AdditionalKafkaClustersConfig, KafkaAdditionalConfigDBModelV1] {
