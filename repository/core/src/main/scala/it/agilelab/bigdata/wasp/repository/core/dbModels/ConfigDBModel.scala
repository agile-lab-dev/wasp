...
case class SolrConfigDBModelV1(zookeeperConnections: ZookeeperConnectionsConfig, name: String) extends SolrConfigDBModel

case class HBaseConfigDBModelV1(
    coreSiteXmlPath: String,
    hbaseSiteXmlPath: String,
    others: Seq[HBaseEntryConfig],
    name: String
) extends HBaseConfigDBModel

case class KafkaConfigDBModelV1(
    ...
    name: String
) extends KafkaConfigDBModel

case class KafkaAdditionalConfigDBModelV1(name: String, clusters: Map[String, KafkaConfigModel])
    extends KafkaAdditionalConfigDBModel

case class SparkBatchConfigDBModelV1(
    appName: String,
    ...
    name: String
) extends SparkBatchConfigDBModel

case class SparkStreamingConfigDBModelV1(
    appName: String,
    master: ConnectionConfig,
    driver: SparkDriverConfig,
    executorCores: Int,
    ...
    name: String
) extends SparkStreamingConfigDBModel

case class ElasticConfigDBModelV1(connections: Seq[ConnectionConfig], name: String) extends ElasticConfigDBModel

case class JdbcConfigDBModelV1(connections: Map[String, JdbcConnectionConfig], name: String) extends JdbcConfigDBModel

case class TelemetryConfigDBModelV1(
    val name: String,
    writer: String,
...
case class NifiConfigDBModelV1(nifiBaseUrl: String, nifiApiPath: String, nifiUiPath: String, name: String)
    extends NifiConfigDBModel

case class CompilerConfigDBModelV1(compilerInstances: Int, name: String) extends CompilerConfigDBModel
