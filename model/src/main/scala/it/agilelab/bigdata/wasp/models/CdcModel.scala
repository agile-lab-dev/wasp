...
/** A named model for mutations coming from a CDC tool. This model should be used together with the Cdc writer plugin in
  * order to write these mutations into a Delta Lake table on HDFS.
  *
...
case class CdcModel(override val name: String, uri: String, schema: String, options: CdcOptions = CdcOptions.default)
