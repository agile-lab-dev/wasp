...
case class JMXTelemetryConfigModel(
    query: String,
...
case class TelemetryTopicConfigModel(
    topicName: String,
    partitions: Int,
    replica: Int,
...
object TelemetryTopicConfigModelMessageFormat extends SprayJsonSupport with DefaultJsonProtocol {
  ...
  implicit lazy val JMXTelemetryConfigModelFormat: RootJsonFormat[JMXTelemetryConfigModel] = jsonFormat5(
    JMXTelemetryConfigModel.apply
  )
  implicit lazy val telemetryTopicConfigModelFormat: RootJsonFormat[TelemetryTopicConfigModel] = jsonFormat5(
