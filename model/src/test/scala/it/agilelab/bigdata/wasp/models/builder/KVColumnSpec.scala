...
class KVColumnSpec extends FlatSpec with Matchers {
  ...
  it should "generate it correctly" in {
    assert(
      KVColumn.primitive((x: BigClass) => x.aString, "ciao") ===
