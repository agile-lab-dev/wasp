...
/**
 * Custom version of {@link JsonEncoder} that does not wrap values of fields of type union.
 *
 * @author Nicolò Bidotti
 */
// code identical to org.apache.avro.io.JsonEncoder with the exception of writeIndex, because some stuff is private and
// we can't access it otherwise
public class SimpleUnionJsonEncoder extends ParsingEncoder implements Parser.ActionHandler {
    private static final String LINE_SEPARATOR = System.getProperty("line.separator");
    final Parser parser;
    private JsonGenerator out;

    // from org.apache.avro.io.JsonDecoder, because it's private and we can't access it otherwise
