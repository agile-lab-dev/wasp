...
case class AddTopic(
    topic: String = NewKafkaAdminActor.topic,
    partitions: Int = NewKafkaAdminActor.partitions,
    replicas: Int = NewKafkaAdminActor.replicas
) extends KafkaAdminMessage
