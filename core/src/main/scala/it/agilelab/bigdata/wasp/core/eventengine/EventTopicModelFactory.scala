...
object EventReaderModelFactory {
  ...
  /** Bypass user's dedicated API in order to be able to generate StreamingReaderModel objects at runtime with
    * configurable values
    *
    * @param modelSettings
    *   is the settings object containing parameters of the StreamingReaderModel
    * @return
    *   a new (KAFKA) StreamingReaderModel
    */
