...
case class KafkaConfigModel(connections: Seq[ConnectionConfig],
                            ingest_rate: String,
	                          ...
	                          decoder_fqcn: String,
	                          batch_send_size: Int,
														otherConfigs: Seq[KafkaEntryConfigModel],
														name: String) extends Model {

	def toTinyConfig() = TinyKafkaConfig(connections, batch_send_size, default_encoder, encoder_fqcn, partitioner_fqcn, otherConfigs)
...
case class KafkaEntryConfigModel(key: String, value: String) {
