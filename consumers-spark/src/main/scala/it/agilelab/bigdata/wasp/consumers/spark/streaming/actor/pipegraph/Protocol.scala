...
object Protocol {
  ...
  /** message sent from [[PipegraphGuardian]] to
    * [[it.agilelab.bigdata.wasp.consumers.spark.streaming.actor.master.SparkConsumersStreamingMasterGuardian]] to
    * obtain work
    */
  ...
  /** Self message to signal monitoring of etl
    ...
    *   the assigned worker
    */
  private[pipegraph] case class MonitorETL(worker: ActorRef, etl: StructuredStreamingETLModel) extends Protocol
