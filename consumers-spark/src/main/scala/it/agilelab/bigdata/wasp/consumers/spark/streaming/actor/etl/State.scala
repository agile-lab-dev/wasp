...
object State {
  ...
  /** [[StructuredStreamingETLActor]] is waiting to be activated by the
  ...
  /** [[StructuredStreamingETLActor]] is waiting to be materialized by the
    * [[it.agilelab.bigdata.wasp.consumers.spark.streaming.actor.pipegraph.PipegraphGuardian]]
    */
  case object WaitingToBeMaterialized extends State

  /** [[StructuredStreamingETLActor]] is waiting to be monitored by the
    * [[it.agilelab.bigdata.wasp.consumers.spark.streaming.actor.pipegraph.PipegraphGuardian]]
    */
