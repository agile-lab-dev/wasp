...
object Protocol {
  ...
  /** Alias object [[PipegraphMessages.SystemPipegraphsStarted]]
    */
  val SystemPipegraphsStarted: PipegraphMessages.SystemPipegraphsStarted.type =
    PipegraphMessages.SystemPipegraphsStarted

  /** Message sent from [[SparkConsumersStreamingMasterGuardian]] to
    * [[it.agilelab.bigdata.wasp.consumers.spark.streaming.actor.pipegraph.PipegraphGuardian]] to signal that work has
    * been given to it
    *
    * @param model
    *   The given work
    * @param instance
    *   The instance currently representing the [[PipegraphModel]] to start
    */
  private[actor] case class WorkGiven(model: PipegraphModel, instance: PipegraphInstanceModel) extends Protocol

  /** Message sent from [[SparkConsumersStreamingMasterGuardian]] to
    * [[it.agilelab.bigdata.wasp.consumers.spark.streaming.actor.pipegraph.PipegraphGuardian]] to signal that work has
    * not been given to it due to an error
    */
  ...
  /** Message sent from [[SparkConsumersStreamingMasterGuardian]] to
    * [[it.agilelab.bigdata.wasp.consumers.spark.streaming.actor.pipegraph.PipegraphGuardian]] to signal that work is
    * available
    */
