...
object Protocol {
  ...
  /** Message sent from [[StructuredStreamingETLActor]] to
    * [[it.agilelab.bigdata.wasp.consumers.spark.streaming.actor.pipegraph.PipegraphGuardian]] to signal successful
    * activation of a [[StructuredStreamingETLModel]]
    * @param etl
    *   The etl activated
    */
  ...
  /** Message sent from [[StructuredStreamingETLActor]] to
    * [[it.agilelab.bigdata.wasp.consumers.spark.streaming.actor.pipegraph.PipegraphGuardian]] to signal failed
    * activation of a [[StructuredStreamingETLModel]]
    * @param etl
    *   The etl whose activation failed
    * @param reason
    *   The reason of the activation failure
    */
  ...
  /** Message sent from [[StructuredStreamingETLActor]] to
    ...
    * materialization of a [[StructuredStreamingETLModel]]
    * @param etl
    *   The etl whose materialization failed
    * @param reason
    *   The reason of the materialization failure
    */
  ...
  /** Message sent from [[StructuredStreamingETLActor]] to
    * [[it.agilelab.bigdata.wasp.consumers.spark.streaming.actor.pipegraph.PipegraphGuardian]] to signal failed
    * monitoring of a [[StructuredStreamingETLModel]]
    * @param etl
    *   The etl whose monitoring failed
    * @param reason
    *   The reason of the monitoring failure
    */
  ...
  /** Message sent from [[StructuredStreamingETLActor]] to
    * [[it.agilelab.bigdata.wasp.consumers.spark.streaming.actor.pipegraph.PipegraphGuardian]] to signal successful stop
    * of a [[StructuredStreamingETLModel]]
    * @param etl
    *   The etl stopped
    */
