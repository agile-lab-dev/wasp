...
object Data {
  ...
  case class MaterializingData(
    ...
    def createMaterializedData(): Data =
      MaterializedData(pipegraph, instance, materialized, toBeRetried, shouldStopAll, reason)
  ...
  /** Data of the [[State.Stopped]]
    ...
    */
  case class StoppedData(pipegraph: PipegraphModel, instance: PipegraphInstanceModel, reason: Option[Throwable])
      extends Data
