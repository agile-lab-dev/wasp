...
import org.sparkproject.guava.cache.{CacheBuilder, CacheLoader, LoadingCache}
...
object CompatibilityTelemetryPluginProducer {
  ...
  def load(): CacheLoader[TelemetryMetadataProducerConfig, KafkaProducer[Array[Byte], Array[Byte]]] =
    new CacheLoader[TelemetryMetadataProducerConfig, KafkaProducer[Array[Byte], Array[Byte]]] {
